...
[Nombre de pas]{.slider #gradSteps value=20 min=1 max=100}
  ...
  ctrl = aptitek.createSimulationControl("#grad-sim-ctrl", {
    onStart: () => {
      ...
      if (sim.isPaused) {
        ...
        sim.play(optType, optParam, gradSteps, 200, () => ctrl.setState("idle"));
      }
    },
    onPause:   () => sim && sim.pause(),
    onStop:    () => sim && sim.stop(),
    onRestart: () => sim && sim.play(optType, optParam, gradSteps, 200, () => ctrl.setState("idle"))
  }, invalidation);
  return ctrl;
}
```
