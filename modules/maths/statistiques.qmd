...
::::: {.col}
:::::: {.card-window .h-100}
#### ⚖️ Moyenne [Centre]{.badge .bg-info .ms-auto} {.bi-speedometer2}
...
::::: {.col}
:::::: {.card-window .h-100}
#### 📏 Médiane et quartiles [Position]{.badge .bg-success .ms-auto} {.bi-rulers}
...
::::: {.col}
:::::: {.card-window .h-100}
#### 🧮 Variance [Dispersion]{.badge .bg-warning .ms-auto} {.bi-arrows-angle-expand}
...
::::: {.col}
:::::: {.card-window .h-100}
#### 🎯 Écart type [Unité lisible]{.badge .bg-primary .ms-auto} {.bi-bullseye}
...
::::: {#stats-cabling-feedback .terminal .mt-4 .d-none}
