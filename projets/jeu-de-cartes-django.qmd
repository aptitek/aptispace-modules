...
1. **Présentation & En-tête (OBLIGATOIRE) :** Noms et Prénoms de tous les membres du groupe (critère éliminatoire), règles du jeu retenu et capture d'écran de l'interface principale.
...
| **Critère**                                                                                         | **OUI** | **NON** |
| :-------------------------------------------------------------------------------------------------- | :------ | :------ |
| Présence du fichier `README.md` complet avec Noms et Prénoms de tous les membres, guide et schémas  | ☐       | ☐       |
